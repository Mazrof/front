export default function AuthLayout({
    ...
    return (
        <div className="auth-background flex min-h-screen flex-col items-center justify-center gap-4 p-3 align-middle text-blue-900 w-full">
            <div className="flex md:w-1/2  flex-col items-center justify-evenly gap-4">
