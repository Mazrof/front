...
export default function ViewStories() {
    ...
    if (stories.length === 0) {
        return <div data-test="story-noStories">No stories to display.</div>;
    }

    const currentStory = stories[currentStoryIndex];

    return (
        <div style={{ backgroundColor: currentStory.color }} data-test="story-color">
            <div className="flex h-screen w-screen items-center justify-center">
                ...
                <div className="text-center text-2xl text-white" data-test="story-text">
                    {currentStory.text}
                </div>
                <button
                    onClick={handleNext}
