        ...
        >
            ...
            <g id="SVGRepo_iconCarrier">
                <path
                    ...
                    strokeLinejoin="round"
                ></path>
                <circle cx="8" cy="9" r="2" stroke="gray" strokeLinejoin="round"></circle>
            </g>
        </svg>
    );
}
...
export function FullScreenIcon() {
    return (
        ...
        >
            <path
                fill="white"
                d="M7 22h2c.6 0 1-.4 1-1s-.4-1-1-1H7c-1.1 0-2-.9-2-2v-2c0-.6-.4-1-1-1s-1 .4-1 1v2c0 2.2 1.8 4 4 4zm8 0h2c2.2 0 4-1.8 4-4v-2c0-.6-.4-1-1-1s-1 .4-1 1v2c0 1.1-.9 2-2 2h-2c-.6 0-1 .4-1 1s.4 1 1 1zm0-17h2c1.1 0 2 .9 2 2v2c0 .6.4 1 1 1s1-.4 1-1V7c0-2.2-1.8-4-4-4h-2c-.6 0-1 .4-1 1s.4 1 1 1zM4 10c.6 0 1-.4 1-1V7c0-1.1.9-2 2-2h2c.6 0 1-.4 1-1s-.4-1-1-1H7C4.8 3 3 4.8 3 7v2c0 .6.4 1 1 1z"
            ></path>
        </svg>
    );
}
export function QuitFullScreenIcon() {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
        ...
        >
            <path
                fill="white"
                fill-rule="evenodd"
                d="M10 22.75C9.58579 22.75 9.25 22.4142 9.25 22 9.25 20.0932 9.24841 18.7385 9.11024 17.7108 8.97498 16.7048 8.72131 16.1251 8.2981 15.7019 7.87489 15.2787 7.29524 15.025 6.28915 14.8898 5.26149 14.7516 3.90682 14.75 2 14.75 1.58579 14.75 1.25 14.4142 1.25 14 1.25 13.5858 1.58579 13.25 2 13.25H2.05641C3.89417 13.25 5.34981 13.25 6.48902 13.4031 7.66145 13.5608 8.61039 13.8929 9.35876 14.6412 10.1071 15.3896 10.4392 16.3386 10.5969 17.511 10.75 18.6502 10.75 20.1058 10.75 21.9436 10.75 21.9623 10.75 21.9812 10.75 22 10.75 22.4142 10.4142 22.75 10 22.75zM2.01343 10.75H2C1.58579 10.75 1.25 10.4142 1.25 10 1.25 9.58579 1.58579 9.25 2 9.25 3.17484 9.25 4.14588 9.24986 4.96888 9.21568 5.38274 9.1985 5.73217 9.52006 5.74935 9.93392 5.76654 10.3478 5.44498 10.6972 5.03112 10.7144 4.17365 10.75 3.17242 10.75 2.01343 10.75zM8.2981 9.35876C8.0052 9.06586 8.0052 8.59099 8.2981 8.2981 8.72131 7.87489 8.97498 7.29524 9.11024 6.28915 9.24841 5.26149 9.25 3.90682 9.25 2 9.25 1.58579 9.58579 1.25 10 1.25 10.4142 1.25 10.75 1.58579 10.75 2L10.75 2.05642C10.75 3.89418 10.75 5.34981 10.5969 6.48902 10.4392 7.66145 10.1071 8.61039 9.35876 9.35876 9.06586 9.65165 8.59099 9.65165 8.2981 9.35876zM21.9866 13.25H22C22.4142 13.25 22.75 13.5858 22.75 14 22.75 14.4142 22.4142 14.75 22 14.75 20.8252 14.75 19.8541 14.7501 19.0311 14.7843 18.6173 14.8015 18.2678 14.4799 18.2506 14.0661 18.2335 13.6522 18.555 13.3028 18.9689 13.2856 19.8263 13.25 20.8276 13.25 21.9866 13.25zM15.7019 14.6412C15.9948 14.9341 15.9948 15.409 15.7019 15.7019 15.2787 16.1251 15.025 16.7048 14.8898 17.7108 14.7516 18.7385 14.75 20.0932 14.75 22 14.75 22.4142 14.4142 22.75 14 22.75 13.5858 22.75 13.25 22.4142 13.25 22L13.25 21.9436C13.25 20.1058 13.25 18.6502 13.4031 17.511 13.5608 16.3386 13.8929 15.3896 14.6412 14.6412 14.9341 14.3483 15.409 14.3483 15.7019 14.6412zM17.7108 9.11024C18.7385 9.24841 20.0932 9.25 22 9.25 22.4142 9.25 22.75 9.58579 22.75 10 22.75 10.4142 22.4142 10.75 22 10.75 21.9812 10.75 21.9623 10.75 21.9436 10.75 20.1058 10.75 18.6502 10.75 17.511 10.5969 16.3386 10.4392 15.3896 10.1071 14.6412 9.35876 13.8929 8.61039 13.5608 7.66145 13.4031 6.48902 13.25 5.34981 13.25 3.89417 13.25 2.05641V2C13.25 1.58579 13.5858 1.25 14 1.25 14.4142 1.25 14.75 1.58579 14.75 2 14.75 3.90682 14.7516 5.26149 14.8898 6.28915 15.025 7.29524 15.2787 7.87489 15.7019 8.2981 16.1251 8.72131 16.7048 8.97498 17.7108 9.11024z"
                clip-rule="evenodd"
            ></path>
        </svg>
    );
...
export function VoiceCallIcon() {
    return (
        <svg
            ...
            fill-rule="evenodd"
            clip-rule="evenodd"
            data-test="chatList-chatRoom-voiceCallIcon"
        >
            <path d="M8.26 1.289l-1.564.772c-5.793 3.02 2.798 20.944 9.31 20.944.46 0 .904-.094 1.317-.284l1.542-.755-2.898-5.594-1.54.754c-.181.087-.384.134-.597.134-2.561 0-6.841-8.204-4.241-9.596l1.546-.763-2.875-5.612zm7.746 22.711c-5.68 0-12.221-11.114-12.221-17.832 0-2.419.833-4.146 2.457-4.992l2.382-1.176 3.857 7.347-2.437 1.201c-1.439.772 2.409 8.424 3.956 7.68l2.399-1.179 3.816 7.36s-2.36 1.162-2.476 1.215c-.547.251-1.129.376-1.733.376" />
        </svg>
    );
}
type VideoCallIconProps = {
    color: string;
};
export function VideoCallIcon({ color }: VideoCallIconProps) {
    return (
        <svg
            width="24"
            height="24"
            ...
            fillRule="evenodd"
            clipRule="evenodd"
            data-test="chatList-chatRoom-videoCallIcon"
        >
            <path
                fill={`${color}`}
