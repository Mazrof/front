...
import { editMember } from "@/services/Channel";
...
export default function EditMember({ channelId, isOpen, onClose }: EditMemberProps) {
    ...
    const onSubmit: SubmitHandler<MemberFormInputs> = async ({
        ...
        try {
            const response = await editMember({ role, hasDownloadPermissions }, channelId, userId);
