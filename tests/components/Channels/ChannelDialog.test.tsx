...
jest.mock("../../../components/ui/dialog", () => ({
    Dialog: ({ children, open, onOpenChange }) => <div data-testid="dialog">{children}</div>,
...
jest.mock("../../../components/ui/button", () => ({
    Button: ({ children, onClick, type, disabled, variant, className, "data-test": dataTest }) => (
        <button
            onClick={onClick}
            type={type}
            disabled={disabled}
...
jest.mock("../../../components/ui/input", () => ({
    Input: ({ id, placeholder, className, "data-test": dataTest, ...props }) => (
        <input
            id={id}
...
jest.mock("../../../components/ui/radio-group", () => ({
    ...
    RadioGroupItem: ({ value, id, className, "data-test": dataTest }) => (
        <input type="radio" value={value} id={id} className={className} data-testid={dataTest} />
    ),
}));

jest.mock("../../../components/ui/checkbox", () => ({
    Checkbox: ({ id, className, "data-test": dataTest, value, ...props }) => (
        <input
            type="checkbox"
            id={id}
            className={className}
...
describe("ChannelDialog", () => {
    ...
    it("displays validation errors for invalid input", async () => {
        ...
        expect(
            await screen.findByText("Channel name must be at least 3 characters")
        ).toBeInTheDocument();
    });
